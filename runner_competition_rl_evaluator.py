...
from Discrete_PID.discrete_rl_pid_eval_agent import PIDEvalAgent
...
def main():
    ...
    for i in range(num_trials):
        scores = run(agent_class=agent_class,
                     agent_config_file_path=Path("./configurations/agent_configuration.json"),
                     carla_config_file_path=Path("./configurations/carla_configuration.json"),
                     num_laps=num_laps)
